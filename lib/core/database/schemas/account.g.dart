...
final AccountSchema = CollectionSchema(
  name: r'Account',
  id: int.parse('-6646797162501847804'),
  properties: {
...
extension AccountQueryFilter
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> deletedAtIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> deletedAtIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> deletedAtEqualTo(
      DateTime? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'deletedAt',
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> deletedAtGreaterThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> deletedAtLessThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> deletedAtBetween(
    DateTime? lower,
    DateTime? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension AccountQuerySortBy on QueryBuilder<Account, Account, QSortBy> {
  ...
  QueryBuilder<Account, Account, QAfterSortBy> sortByDeletedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'deletedAt', Sort.asc);
    });
  }

  QueryBuilder<Account, Account, QAfterSortBy> sortByDeletedAtDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension AccountQuerySortThenBy
  ...
  QueryBuilder<Account, Account, QAfterSortBy> thenByDeletedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'deletedAt', Sort.asc);
    });
  }

  QueryBuilder<Account, Account, QAfterSortBy> thenByDeletedAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'deletedAt', Sort.desc);
    });
  }
...
extension AccountQueryWhereDistinct
  ...
  QueryBuilder<Account, Account, QDistinct> distinctByDeletedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension AccountQueryProperty
  ...
  QueryBuilder<Account, String, QQueryOperations> accountTypeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'accountType');
    });
  }

  QueryBuilder<Account, int, QQueryOperations> balanceProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Account, DateTime?, QQueryOperations> deletedAtProperty() {
    return QueryBuilder.apply(this, (query) {
