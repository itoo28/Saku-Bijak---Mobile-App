...
final GoalSchema = CollectionSchema(
  name: r'Goal',
  id: int.parse('4693499363663894908'),
  properties: {
...
void _goalSerialize(
  ...
  writer.writeLong(offsets[6], object.targetAmount);
...
Goal _goalDeserialize(
  ...
  object.targetAmount = reader.readLong(offsets[6]);
...
extension GoalQueryProperty on QueryBuilder<Goal, Goal, QQueryProperty> {
  ...
  QueryBuilder<Goal, int, QQueryOperations> targetAmountProperty() {
    return QueryBuilder.apply(this, (query) {
